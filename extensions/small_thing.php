...
if( get_option('wc_settings_woozen_st_cartButtonText') !== "" ){
    ...
    function weart_add_to_cart_button_text() {
        return get_option('wc_settings_woozen_st_cartButtonText'); 
    }
}

// quantity for product loop
if( get_option('wc_settings_woozen_st_quantityForLoop') !== "no" ){
